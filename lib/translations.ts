...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    emergencyContactButton: 'Hotline',
    emergencyModalTitle: 'Hotlines',
    ...
    emergencyContactNote: 'Hotline For Issues: ',
    stepLanguage: 'Language',
    stepDetails: 'Details',
    stepThankYou: 'Video',
    thankYouTitle: 'Thank you, you are officially invited',
    thankYouSubtitle: 'Stay updated by joining our official WhatsApp channel.',
  ...
  si: {
    ...
    emergencyContactButton: 'හදිසි ඇමතුම් / Hotline',
    emergencyModalTitle: 'හදිසි ඇමතුම් සේවාව / Hotline',
    ...
    thankYouTitle: 'ස්තූතියි, ඔබට නිල වශයෙන් ආරාධනා කර ඇත!',
    thankYouSubtitle: 'අපගේ නිල WhatsApp චැනලයට එකතු වී අලුත්ම තොරතුරු ලබාගන්න.',
